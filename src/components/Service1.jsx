		...
		<div path="service1" className="md-px-14  py-16 max-w-screen-2xl mx-auto">
						...
						<ul className="flex flex-wrap gap-8 items-center justify-center">
							<div className="space-y-8 gap-4 items-center justify-center">
								...
								>
									<span className="block w-12 h-12 m-0 p-0">
										<img
											src="https://img.icons8.com/dusk/64/server.png"
											alt=""
										/>
									</span>
								...
								>
									<span className=" block w-12 h-12 m-0 p-0">
										<img
											width="80"
											height="80"
											src="https://img.icons8.com/officel/80/immigration.png"
											alt="immigration"
										/>
									</span>
									<h3 className="hover:-translate-y-5 hover:border-b-4 hover:border-indigo-700 transition-all duration-300 text-white">
							...
							<div className="space-y-8 gap-4 items-center justify-center">
								...
								>
									<span className=" block w-12 h-12 m-0 p-0">
										<img
											src="https://img.icons8.com/plasticine/100/cost.png"
											alt=""
										/>
									</span>
									<h3 className="hover:-translate-y-5 hover:border-b-4 hover:border-indigo-700 transition-all duration-300 text-white">
								...
								>
									<span className=" block w-12 h-12 m-0 p-0 flex-wrap">
										<img
											width="64"
											height="64"
											src="https://img.icons8.com/dusk/64/cloud.png"
											alt="cloud"
										/>
									</span>
									<h3 className="hover:-translate-y-5 hover:border-b-4 hover:border-indigo-700 transition-all duration-300 text-white">
						...
						<Table striped>
							...
							<Table.Body className="divide-y text-1xl font-semibold text-neturalDGrey text-center">
								<Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
									...
									<Table.Cell>
										インフラ構築:インスタンス起動、ミドルウェアインストール、
										<br />
										FW設定、ロードバランサー作成、バックアップ設定、DNS設定 など
									</Table.Cell>
								...
								<Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
									...
									<Table.Cell>
										お客様の環境の調査、検証、AWS環境の構築、移行作業の実施 など
									</Table.Cell>
									<Table.Cell>お問い合わせください</Table.Cell>
								</Table.Row>
								<Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
									...
									<Table.Cell>
										ファイルサーバー用途であればこちらもおすすめ。
										<br />
										フルマネージド型のファイルサーバーを一式10万円で構築するパッケージサービス
									</Table.Cell>
									<Table.Cell>お問い合わせください</Table.Cell>
								</Table.Row>
							</Table.Body>
			...
			<div className="mb-10 px-20">
				...
				<div className="mb-8 flex items-center px-20">
					<div className="mr-4">
						<a href="/aws">
							<img className="cursor-pointer hover:text-blue-500" src={aws} />
						</a>
					</div>
					<div>
						<a href="/aws">
						...
						<br />
						<a href="/aws">
							<p className="text-1xl font-bold cursor-pointer hover:text-blue-500">
								Find out more &#62;
							</p>
						</a>
