...
const MyFooter = () => {
    return (
        <Footer className="footer">
            <div className="w-full px-10 py-10 text-white footer-container" id="faq">
                <div className="grid w-full justify-center items-center sm:flex sm:justify-between md:flex md:grid-cols-1">
                    <div className="space-y-4 mb-8 footer-content footer-about">
                        <Footer.Brand
                            href="/"
                            src={logo}
                            alt="NEX4 Logo"
                    ...
                    <div className="grid grid-cols-2 gap-4 sm:mt-4 sm:grid-cols-3 sm:gap-6 hover:text-bluehover font-semibold footer-content">
